...
STRUCTURE_VARIANTS={
 ...
 'ZITAT_BODY':('{"quote":"...","body":"...","question":"..."}','Nur ein in TITEL/ZUSAMMENFASSUNG woertlich vorhandenes Fahrer-Zitat unveraendert im quote-Feld verwenden; wenn kein woertliches Fahrer-Zitat vorhanden ist, die belegte Fahreraussage ohne erfundene Woertlichkeit formulieren. Danach Kontext und Community-Frage.'),
}
