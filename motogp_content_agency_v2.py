...
VERSION='V8.5.4';TOP10=Path('memory/RACING_TOP10_POOL.json');RACING_LANGUAGE_LEXICON=Path('config/RACING_LANGUAGE_LEXICON.md')
def racing_language_lexicon():
 try:return RACING_LANGUAGE_LEXICON.read_text(encoding='utf-8').strip()
 except Exception:return 'Lexikon nicht verfügbar. Schreibe nur belegte Fakten in natürlichem Deutsch; nichts ergänzen.'
