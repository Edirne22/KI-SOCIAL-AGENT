"""Racing Agency V8.5.3 run controller.
...
STATE=Path('memory/RACING_RUN_STATE.json');ARCH_VERSION='V8.5.3';TERMINAL={'BLOCKED','READY_FOR_APPROVAL','APPROVED','PUBLISHED','CLOSED'};DUPLICATE_WINDOW_SECONDS=30*60
