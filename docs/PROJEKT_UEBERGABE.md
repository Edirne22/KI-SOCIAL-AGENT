...
C) Doku-Aufräumen
🔴 docs/PROJEKT_UEBERGABE.md Zeile 70 – letzter deepseek-v4-flash-Rest → moonshotai/kimi-k3

🔴 Router-Module-Tabelle in Übergabe – image_router.py-Zeile ergänzen: Fallback 2 = flux.2-klein-4b
...
🟡 Router-Erweiterung (Config als enabled: false):
...
Neuer Auftrag = neuer Chat (heute verletzt → Session 2 fehlgeschlagen)
...
Telegram (bis Router-Fix)
✅ Router-Fix ist erledigt → Telegram funktioniert wieder normal
...
Reset: ~02:00 Uhr deutscher Zeit (heute Nacht)
...
📄 PROJEKT_UEBERGABE.md Zeile 70 korrigieren

📄 Router-Tabelle aktualisieren
